...
Repository home: https://github.com/ManageIQ/topological_inventory-api-jsclient
...
## Updating the client from the Swagger.yml

First copy `topological_inventory-api/public/doc/swagger-2-v0.0.1.yaml` from the topological_inventory-api to `conf/swagger-2-v0.0.1.yaml`.
